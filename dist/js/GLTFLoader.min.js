THREE.GLTFLoader = (function() {
	...
	e.prototype = {
		...
		load: function(e, t, r, a) {
			...
			var s = function(t) {
				...
				o = new THREE.FileLoader(i.manager);
			o.setPath(this.path),
		...
		parse: function(e, c, d, h) {
			var f,
				m = {};
			if ("string" == typeof e) f = e;
			else if (
				THREE.LoaderUtils.decodeText(new Uint8Array(e, 0, 4)) === i
			) {
				try {
					m[t.KHR_BINARY_GLTF] = new function(e) {
						...
						var a = new DataView(e, s),
							n = 0;
						for (; n < a.byteLength; ) {
							var l = a.getUint32(n, !0);
							n += 4;
							var u = a.getUint32(n, !0);
							if (((n += 4), u === o.JSON)) {
								var p = new Uint8Array(e, s + n, l);
			...
			if (void 0 === E.asset || E.asset.version[0] < 2)
				...
				if (E.extensionsUsed)
					for (var v = 0; v < E.extensionsUsed.length; ++v) {
						var T = E.extensionsUsed[v],
							g = E.extensionsRequired || [];
						switch (T) {
							...
							case t.KHR_DRACO_MESH_COMPRESSION:
								m[T] = new l(E, this.dracoLoader);
								break;
							case t.MSFT_TEXTURE_DDS:
								m[t.MSFT_TEXTURE_DDS] = new r(E);
								break;
							case t.KHR_TEXTURE_TRANSFORM:
								m[t.KHR_TEXTURE_TRANSFORM] = new u(E);
								break;
							default:
								g.indexOf(T) >= 0 &&
									console.warn(
	...
	(a.prototype.loadLight = function(e) {
		...
		switch (r.type) {
			case "directional":
				(t = new THREE.DirectionalLight(a)).target.position.set(
					0,
					0,
					-1
				),
	...
	function p() {
		return {
			...
			extendParams: function(e, t, r) {
				...
				if (
					(void 0 !== a.diffuseTexture &&
						d.push(r.assignTexture(e, "map", a.diffuseTexture)),
					...
					d.push(r.assignTexture(e, "glossinessMap", f)),
						d.push(r.assignTexture(e, "specularMap", f));
				}
			...
			cloneMaterial: function(e) {
				...
				t.isGLTFSpecularGlossinessMaterial = !0;
				for (
					var r = this.specularGlossinessParams, a = 0, n = r.length;
					a < n;
					a++
				)
					t[r[a]] = e[r[a]];
			...
			refreshUniforms: function(e, t, r, a, n, i) {
				if (!0 === n.isGLTFSpecularGlossinessMaterial) {
					...
					(o.opacity.value = n.opacity),
						...
						void 0 !== s &&
							...
							o.uvTransform.value.copy(s.matrix)),
	...
	(l.prototype.decodePrimitive = function(e, t) {
		var r = this.json,
			...
			o = {},
			l = {};
		for (var u in i) u in y && (s[y[u]] = i[u]);
		for (u in e.attributes)
			if (void 0 !== y[u] && void 0 !== i[u]) {
				var p = r.accessors[e.attributes[u]],
					c = g[p.componentType];
				(l[y[u]] = c), (o[y[u]] = !0 === p.normalized);
			}
		...
		(c.prototype = Object.create(THREE.Interpolant.prototype)),
		...
		(c.prototype.interpolate_ = function(e, t, r, a) {
			for (
	...
	var d = 0,
		...
		_ = "MASK",
		b = "BLEND",
		x = { "image/png": THREE.RGBAFormat, "image/jpeg": THREE.RGBFormat };
	function w(e, t) {
	...
	function C(e, r) {
		for (var a = 0, n = e.length; a < n; a++) {
			...
			if (
				...
				void 0,
				(l = s.extensions
					? s.extensions[t.KHR_DRACO_MESH_COMPRESSION]
					: void 0),
				(u = o.extensions
					? o.extensions[t.KHR_DRACO_MESH_COMPRESSION]
					: void 0),
				l && u
					? l.bufferView === u.bufferView &&
					  U(l.attributes, u.attributes)
					: s.indices === o.indices && U(s.attributes, o.attributes))
			)
				return i.promise;
		}
		var s, o, l, u;
	...
	function N(e, t, r) {
		...
		for (var s in a) {
			var o = y[s];
			o && (o in e.attributes || n.push(i(a[s], o)));
		}
		...
		return (
			...
			Promise.all(n).then(function() {
				return void 0 !== t.targets
					? (function(e, t, r) {
							for (
								var a = !1, n = !1, i = 0, s = t.length;
								i < s &&
								(void 0 !== (u = t[i]).POSITION && (a = !0),
								void 0 !== u.NORMAL && (n = !0),
								!a || !n);
								i++
							);
							...
							return Promise.all([
								...
								for (
									var i = r[0], s = r[1], o = 0, l = t.length;
									o < l;
									o++
								) {
									var u = t[o],
										p = "morphTarget" + o;
									if (a && void 0 !== u.POSITION) {
										var c = i[o];
										c.name = p;
										for (
											var d = e.attributes.position,
												h = 0,
												f = c.count;
											h < f;
											h++
									...
									if (n && void 0 !== u.NORMAL) {
										var m = s[o];
										m.name = p;
										var E = e.attributes.normal;
										for (h = 0, f = m.count; h < f; h++)
											m.setXYZ(
												h,
												m.getX(h) + E.getX(h),
												m.getY(h) + E.getY(h),
								...
								return (
									a && (e.morphAttributes.position = i),
									n && (e.morphAttributes.normal = s),
									e
								);
							});
					  })(e, t.targets, r)
	...
	return (
		...
		(G.prototype.markDefs = function() {
			for (
				...
				for (var o = t[i].joints, l = 0, u = o.length; l < u; l++)
					e[o[l]].isBone = !0;
		...
		(G.prototype.getDependency = function(e, r) {
			var a = e + ":" + r,
				n = this.cache.get(a);
			if (!n) {
				switch (e) {
		...
		(G.prototype.getMultiDependencies = function(e) {
			for (var t = {}, r = [], a = 0, n = e.length; a < n; a++) {
				var i = e[a],
		...
		(G.prototype.loadBuffer = function(e) {
			...
			return new Promise(function(e, t) {
				a.load(w(r.uri, n.path), e, void 0, function() {
					t(
						new Error(
			...
			return (
				...
				Promise.all(n).then(function(e) {
					...
					if (d && d !== p) {
						...
						m ||
							((n = new l(s)),
							(m = new THREE.InterleavedBuffer(n, d / u)),
							t.cache.add(f, m)),
					...
					if (void 0 !== a.sparse) {
						var E = S.SCALAR,
							v = g[a.sparse.indices.componentType],
							T = a.sparse.indices.byteOffset || 0,
							R = a.sparse.values.byteOffset || 0,
							M = new v(e[1], T, a.sparse.count * E),
						...
						for (var H = 0, L = M.length; H < L; H++) {
							...
							if (
								(i.setX(A, y[H * o]),
								o >= 2 && i.setY(A, y[H * o + 1]),
								o >= 3 && i.setZ(A, y[H * o + 2]),
								o >= 4 && i.setW(A, y[H * o + 3]),
								o >= 5)
							)
								throw new Error(
		...
		(G.prototype.loadTexture = function(e) {
			var r,
				...
				l = n.textures[e],
				u = l.extensions || {},
				p = (r = u[t.MSFT_TEXTURE_DDS]
					? n.images[u[t.MSFT_TEXTURE_DDS].source]
					: n.images[l.source]).uri,
				c = !1;
			return (
				void 0 !== r.bufferView &&
					(p = a
				...
				Promise.resolve(p)
					.then(function(e) {
						...
						return (
							r ||
								(r = u[t.MSFT_TEXTURE_DDS]
									? a.extensions[t.MSFT_TEXTURE_DDS].ddsLoader
									: s),
							new Promise(function(t, a) {
								r.load(w(e, i.path), t, void 0, a);
							})
						);
					})
					.then(function(e) {
						!0 === c && o.revokeObjectURL(p),
							(e.flipY = !1),
							void 0 !== l.name && (e.name = l.name),
							r.mimeType in x && (e.format = x[r.mimeType]);
						var t = (n.samplers || {})[l.sampler] || {};
						return (
							(e.magFilter =
								R[t.magFilter] || THREE.LinearFilter),
							(e.minFilter =
								R[t.minFilter] ||
								THREE.LinearMipMapLinearFilter),
							(e.wrapS = M[t.wrapS] || THREE.RepeatWrapping),
							(e.wrapT = M[t.wrapT] || THREE.RepeatWrapping),
							e
						);
					})
			);
		}),
		(G.prototype.assignTexture = function(e, r, a) {
			var n = this;
			return this.getDependency("texture", a.index).then(function(i) {
				if (n.extensions[t.KHR_TEXTURE_TRANSFORM]) {
					var s =
						void 0 !== a.extensions
		...
		(G.prototype.loadMaterial = function(e) {
			...
			if (o[t.KHR_MATERIALS_PBR_SPECULAR_GLOSSINESS]) {
				var u = n[t.KHR_MATERIALS_PBR_SPECULAR_GLOSSINESS];
				(r = u.getMaterialType(i)), l.push(u.extendParams(s, i, this));
			} else if (o[t.KHR_MATERIALS_UNLIT]) {
				var p = n[t.KHR_MATERIALS_UNLIT];
				(r = p.getMaterialType(i)), l.push(p.extendParams(s, i, this));
			} else {
				...
				void 0 !== c.baseColorTexture &&
					l.push(this.assignTexture(s, "map", c.baseColorTexture)),
					(s.metalness =
			...
			!0 === i.doubleSided && (s.side = THREE.DoubleSide);
			var h = i.alphaMode || A;
			return (
				h === b
					? (s.transparent = !0)
					: ((s.transparent = !1),
					  h === _ &&
							(s.alphaTest =
								void 0 !== i.alphaCutoff
									? i.alphaCutoff
									: 0.5)),
				void 0 !== i.normalTexture &&
					r !== THREE.MeshBasicMaterial &&
					(l.push(
						this.assignTexture(s, "normalMap", i.normalTexture)
					),
					(s.normalScale = new THREE.Vector2(1, 1)),
					void 0 !== i.normalTexture.scale &&
						s.normalScale.set(
							i.normalTexture.scale,
							i.normalTexture.scale
						)),
				void 0 !== i.occlusionTexture &&
					r !== THREE.MeshBasicMaterial &&
					(l.push(this.assignTexture(s, "aoMap", i.occlusionTexture)),
				...
				void 0 !== i.emissiveTexture &&
					r !== THREE.MeshBasicMaterial &&
					l.push(
						this.assignTexture(s, "emissiveMap", i.emissiveTexture)
					),
					...
					return (
						(e =
							r === THREE.ShaderMaterial
								? n[
										t.KHR_MATERIALS_PBR_SPECULAR_GLOSSINESS
								  ].createMaterial(s)
								: new r(s)),
		...
		(G.prototype.loadGeometries = function(e) {
			var r,
				...
				s = (function(e) {
					...
					for (var n = 1, i = e.length; n < i; n++) {
						var s = e[n];
						if (r.mode !== s.mode) return !1;
						if (void 0 === s.indices) return !1;
						if (
							s.extensions &&
							s.extensions[t.KHR_DRACO_MESH_COMPRESSION]
						)
							return !1;
						if (!U(r.attributes, s.attributes)) return !1;
						var o = s.targets || [];
						if (a.length !== o.length) return !1;
						for (var l = 0, u = a.length; l < u; l++)
							if (!U(a[l], o[l])) return !1;
					}
					return !0;
				})(e);
			function o(e) {
			...
			s && ((r = e), (e = [e[0]]));
			for (var l = [], u = 0, p = e.length; u < p; u++) {
				var c,
					d = e[u],
					h = C(i, d);
				if (h) l.push(h);
					...
					(c =
						d.extensions &&
						d.extensions[t.KHR_DRACO_MESH_COMPRESSION]
							? o(d)
							: N(new THREE.BufferGeometry(), d, a)),
						i.push({ primitive: d, promise: c }),
						l.push(c);
			}
				...
				if (s) {
					...
					if (
						...
						(d = (function(e, t, r) {
							for (var a = 0, n = e.length; a < n; a++) {
								var i = e[a];
								if (t === i.baseGeometry && D(r, i.primitives))
									return i.geometry;
							}
							return null;
						})((c = a.multiPassGeometryCache), n, r))
					)
						return [d.geometry];
					var i = new THREE.BufferGeometry();
					for (var o in ((i.name = n.name),
					(i.userData = n.userData),
					n.attributes))
						i.addAttribute(o, n.attributes[o]);
					for (var o in n.morphAttributes)
						i.morphAttributes[o] = n.morphAttributes[o];
					for (var l = [], u = 0, p = r.length; u < p; u++)
						l.push(a.getDependency("accessor", r[u].indices));
					return Promise.all(l).then(function(e) {
						for (
							var t = [], a = 0, s = 0, o = r.length;
							s < o;
							s++
						) {
							for (var l = e[s], u = 0, p = l.count; u < p; u++)
								t.push(l.array[u]);
							i.addGroup(a, l.count, s), (a += l.count);
						}
						return (
							i.setIndex(t),
							c.push({
					...
					if (
						(d = (function(e, t) {
							for (var r = 0, a = e.length; r < a; r++) {
								var n = e[r];
								if (D(t, n.baseGeometries)) return n.geometry;
							}
							return null;
						})((c = a.multiplePrimitivesCache), t))
					) {
						if (null !== d.geometry) return [d.geometry];
					} else {
						i = THREE.BufferGeometryUtils.mergeBufferGeometries(
							t,
							!0
						);
						if (
							(c.push({ geometry: i, baseGeometries: t }),
							null !== i)
						)
							return [i];
					}
		...
		(G.prototype.loadMesh = function(e) {
			...
			return Promise.all(o).then(function(a) {
				return r.loadGeometries(s).then(function(o) {
					for (
						var l = 1 === o.length && o[0].groups.length > 0,
							u = [],
							p = 0,
							c = o.length;
						p < c;
						...
						if (
							...
							(g =
								!0 === i.isSkinnedMesh
									? new THREE.SkinnedMesh(R, S)
									: new THREE.Mesh(R, S)),
								M.mode === v
									? (g.drawMode = THREE.TriangleStripDrawMode)
									: M.mode === T &&
									  (g.drawMode = THREE.TriangleFanDrawMode);
						else if (M.mode === h) g = new THREE.LineSegments(R, S);
						else if (M.mode === m) g = new THREE.Line(R, S);
						else if (M.mode === f) g = new THREE.LineLoop(R, S);
						else {
							if (M.mode !== d)
								throw new Error(
							...
							g = new THREE.Points(R, S);
						}
						Object.keys(g.geometry.morphAttributes).length > 0 &&
							F(g, i),
							(g.name = i.name || "mesh_" + e),
							o.length > 1 && (g.name += "_" + p),
							I(g, i),
							u.push(g);
						for (
							var y = l ? g.material : [g.material],
								H = void 0 !== R.attributes.color,
								L = void 0 === R.attributes.normal,
								A = !0 === g.isSkinnedMesh,
								_ = Object.keys(R.morphAttributes).length > 0,
								b = _ && void 0 !== R.morphAttributes.normal,
								x = 0,
								w = y.length;
							x < w;
							x++
							...
							S = y[x];
							if (g.isPoints) {
								var P = "PointsMaterial:" + S.uuid,
									U = r.cache.get(P);
								U ||
									((U = new THREE.PointsMaterial()),
									THREE.Material.prototype.copy.call(U, S),
								...
								P = "LineBasicMaterial:" + S.uuid;
								var D = r.cache.get(P);
								D ||
									((D = new THREE.LineBasicMaterial()),
									THREE.Material.prototype.copy.call(D, S),
									D.color.copy(S.color),
									(D.lights = !1),
									r.cache.add(P, D)),
									(S = D);
							}
							if (H || L || A || _) {
								P = "ClonedMaterial:" + S.uuid + ":";
								...
								var C = r.cache.get(P);
								C ||
									((C = S.isGLTFSpecularGlossinessMaterial
										? n[
												t
													.KHR_MATERIALS_PBR_SPECULAR_GLOSSINESS
										  ].cloneMaterial(S)
										: S.clone()),
									A && (C.skinning = !0),
									H && (C.vertexColors = THREE.VertexColors),
									L && (C.flatShading = !0),
									_ && (C.morphTargets = !0),
									b && (C.morphNormals = !0),
									r.cache.add(P, C)),
					...
					for (p = 0, c = u.length; p < c; p++) O.add(u[p]);
					return O;
				});
			});
		}),
		...
		(G.prototype.loadAnimation = function(e) {
			for (
				...
				var u = t.channels[o],
					p = t.samplers[u.sampler],
					d = u.target,
					h = void 0 !== d.node ? d.node : d.id,
					f =
						void 0 !== t.parameters
							? t.parameters[p.input]
							: p.input,
					m =
						void 0 !== t.parameters
							? t.parameters[p.output]
							: p.output;
				r.push(this.getDependency("node", h)),
					a.push(this.getDependency("accessor", f)),
					n.push(this.getDependency("accessor", m)),
					i.push(p),
					s.push(d);
			}
			return Promise.all([
					...
					if (void 0 !== d) {
						...
						for (var M = 0, S = R.length; M < S; M++) {
							...
							"CUBICSPLINE" === m.interpolation &&
								((y.createInterpolant = function(e) {
									return new c(
										this.times,
										this.values,
										this.getValueSize() / 3,
								...
								(y.createInterpolant.isInterpolantFactoryMethodGLTFCubicSpline = !0)),
								l.push(y);
						}
					}
				}
		...
		(G.prototype.loadNode = function(e) {
			...
			return new Promise(function(e) {
				!0 === o.isBone
					? e(new THREE.Bone())
					: void 0 !== o.mesh
						? n.getDependency("mesh", o.mesh).then(function(t) {
								var r;
								if (i[o.mesh] > 1) {
									var a = s[o.mesh]++;
									((r = t.clone()).name += "_instance_" + a),
										(r.onBeforeRender = t.onBeforeRender);
									for (
										var n = 0, l = r.children.length;
										n < l;
										n++
									)
										(r.children[n].name +=
											"_instance_" + a),
											(r.children[n].onBeforeRender =
												t.children[n].onBeforeRender);
								} else r = t;
								e(r);
						  })
						: void 0 !== o.camera
							? n.getDependency("camera", o.camera).then(e)
							: o.extensions &&
							  o.extensions[t.KHR_LIGHTS_PUNCTUAL] &&
							  void 0 !==
									o.extensions[t.KHR_LIGHTS_PUNCTUAL].light
								? n
										.getDependency(
											"light",
											o.extensions[t.KHR_LIGHTS_PUNCTUAL]
		...
		(G.prototype.loadScene = (function() {
			function e(t, r, a, n) {
				...
				return n
					...
					.then(function(t) {
						...
						if (i.children)
							for (
								var o = i.children, l = 0, u = o.length;
								l < u;
								l++
							) {
								var p = o[l];
			...
			return function(t) {
				...
				void 0 !== n.name && (i.name = n.name),
					I(i, n),
					n.extensions && P(a, i, n);
				for (
					var s = n.nodes || [], o = [], l = 0, u = s.length;
					l < u;
					l++
				)
					o.push(e(s[l], i, r, this));
